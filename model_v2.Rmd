...
budget_suggestion <- function(input_data){
  ...
  while (next_budget <= current_budget + max_increase) {
    ...
    if (as.character(new_bin) == next_bin) {
      print(paste("Budget increased to reach next bin. New budget:", next_budget))
      return(next_budget)
    }
  }
  
  print("Could not reach next bin within reasonable budget increase.")
