...
final_movieset <- movieset_clean %>% select(name, genre, year, score, votes, budget, gross, runtime)
...
summary(fit6)
last_movie <- final_movieset %>% select(name, genre, score, votes, budget, gross, runtime)
print(last_movie)
```
