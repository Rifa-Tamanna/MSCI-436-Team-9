...
x <- last_movie[, - which(names(last_movie) == "gross")]
y <- last_movie$gross
...
# Function to create scatter plots for a given genre
plot_genre <- function(genre) {
  genre_data <- final_movieset %>% filter(genre == !!genre)
  ggplot(genre_data, aes(x = 1, y = gross)) +
    geom_point(position = position_jitter(width = 0.1)) +
    labs(title = paste("Scatter Plot of", genre, "Movies"),
         x = "Movie",
         y = "Gross Revenue") +
