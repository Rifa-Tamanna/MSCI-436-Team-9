...
## Dataset 
```{r dataset}
movieset <- read.csv("C://Users/sanje/Documents/MSCI-436-Team-9/output.csv")
print(movieset)
```
...
final_movieset <- movieset_clean %>% select(name, genre, year, rating, score, votes, budget, gross, runtime)
