...
budget_suggestion <- function(input_data){
  ...
  while (next_budget <= current_budget + max_increase) {
    ...
    if (as.character(new_bin) == next_bin) {
      print(paste("By increasing your budget by", next_budget - current_budget, "your gross revenue will sit in", next_bin))
      return(next_budget)
    }
  }
  
  print("Your budget is sufficient to satisfy a gross revenue that sits in the highest bin. No changes need to be made to the buget.")
